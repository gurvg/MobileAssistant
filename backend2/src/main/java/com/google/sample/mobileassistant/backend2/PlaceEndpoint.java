 ...
 * the License.
 */
package com.google.sample.mobileassistant.backend2;
 ...
 */
@Api(name = "shoppingassistant", version = "v1", namespace = @ApiNamespace(
    ownerDomain = ApiKeysAndIds.API_OWNER, ownerName = ApiKeysAndIds.API_OWNER,
    packagePath = ApiKeysAndIds.API_PACKAGE_PATH), clientIds = { ApiKeysAndIds.API_EXPLORER_CLIENT_ID,
